...
public:
    enum class Must : uint16_t
    {
        ...
        NoPaint                 = 0x0001,
        NoClipChilds            = 0x0002,
        MousePressEvent         = 0x0004,
        MouseReleaseEvent       = 0x0008,
        MouseMoveEvent          = 0x0010,
        TransformEvent          = 0x0020,
        WhellEvent              = 0x0040,
...
public:
    KRPTFlag<Must>     must             ()                        const noexcept {return _must              ;}
    KRPTScene        * scene            ()                        const noexcept {return _scene             ;}
    KRPTSceneItem    * parent           ()                        const noexcept {return _parent            ;}
    const ItemsList  & childItems       ()                        const noexcept {return _childItems        ;}
    ...
    QPointF            pos              ()                        const noexcept {return _geometry.topLeft();}
    QSizeF             size             ()                        const noexcept {return _geometry.size   ();}
    double             x                ()                        const noexcept {return _geometry.x      ();}
    double             y                ()                        const noexcept {return _geometry.y      ();}
    double             width            ()                        const noexcept {return _geometry.width  ();}
    double             height           ()                        const noexcept {return _geometry.height ();}
    double             right            ()                        const noexcept {return _geometry.right  ();}
    double             bottom           ()                        const noexcept {return _geometry.bottom ();}
    ...
    QTransform         foolTransform    ()                              noexcept;
    QTransform         foolTransformInv ()                              noexcept;
